...
from neuralil.model import TrivialCore, NeuralILModelInfo, NeuralILwithMorse
from neuralil.training import *
from neuralil.utilities import *

gp_activation = create_gp_activation(jax.nn.swish)
...
core_model = TrivialCore(
    layer_widths=CORE_WIDTHS,
    activation_function=gp_activation,
    use_intermediate_biases=True,
    kernel_init=flax.linen.initializers.orthogonal()
)
...
PICKLE_FILE = f"model_params_snn_{instance_code}.pickle"
