...
from neuralil.model import Core, NeuralILwithMorse

MIN_DIST = 1.
TARGET_T = 1200
PICKLE_FILE = pathlib.Path(
    __file__
).parent / "model_params_neuralil_OPTAX_2B25114.pickle"
MAX_NEIGHBORS = 35
...
integrator = Langevin(
    atoms, 1. * units.fs, temperature_K=float(TARGET_T), friction=2e-2
)
